...
@property (weak, nonatomic) IBOutlet UISwitch *WantsTweakInj;

@property (weak, nonatomic) IBOutlet UISwitch *WantsSubstrateInj;
...
@property (weak, nonatomic) IBOutlet UILabel *tinjectorlabel;
@property (weak, nonatomic) IBOutlet UILabel *substratelabel;
