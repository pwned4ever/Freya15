...
const char *print_devicemodel(void) {
//    util_info("Machine Name: %s", g_exp.machine);

    return g_exp.machine;
    
}

const char *print_deviceversion(void) {
//    util_info("iOS version: %s", g_exp.osversion);

    return g_exp.osproductversion;
}
