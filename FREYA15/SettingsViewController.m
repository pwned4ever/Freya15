...
- (void)viewDidLoad {
    ...
    if (back4romset == 2) {
        ...
        [self.WantsTweakInj setHidden:YES];
        [self.WantsSubstrateInj setHidden:YES];
    ...
    if ((checkpspawnhook == 1) && (checkth0rmarkerFinal == 1) && (checkuncovermarker == 0) && (checkchimeramarker == 0) && (checksuckmydTmpRun == 1)) {
        ...
        if (checksubsinj == 1) {
            ...
            [_WantsSubstrateInj setHidden:FALSE];
    ...
    if (((checkuncovermarker == 1) && (checku0slide == 1)) || ((checkuncovermarker == 1) && (checkcylog == 1))){
       ...
       // [self.loadTweaksSwitch setEnabled:FALSE];
        ...
        if (checksubsinj == 1) {
            _substratelabel.hidden = false;
            [_WantsSubstrateInj setOn:YES];
            [_WantsSubstrateInj setEnabled:NO];
            _WantsSubstrateInj.hidden = false;
